...
(function(){
    ...
    var apis = {
        getUser: {url:baseUri+'user/{id}'},
        searchUsers: {url:baseUri+'people?'+sp},
        getTimeline: {url:baseUri+'../shuo/v2/statuses/user_timeline/{id}'},
        getBook: {url:baseUri+'book/user/{id}/collections'},
        getISBNBook: {url:baseUri+'book/isbn/{isbn}'},
        searchBooks: {url:baseUri+'book/search?tag={tag}&'+sp},
        getMovie: {url:baseUri+'movie/{id}'},
        searchMovies: {url:baseUri+'movie/search?tag={tag}&'+sp},
        getMusic: {url:baseUri+'music/{id}'},
        searchMusic: {url:baseUri+'music/search?tag={tag}&'+sp},
        getFavSongs: {url:baseUri+'../people/{id}/favsongs?'+pp},
